...
def main():
    ...
    st.write("Enter your ask below. The app will retrieve relevant chunks using both semantic (FAISS) and keyword (BM25) search, rerank them with a cross-encoder, and generate an answer using Gemini. The LLM will only answer from the provided context.")
